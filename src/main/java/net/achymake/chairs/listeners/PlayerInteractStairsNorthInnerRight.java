...
public class PlayerInteractStairsNorthInnerRight implements Listener {
    private ChairData getChairData() {
        return Chairs.getChairData();
    }
    public PlayerInteractStairsNorthInnerRight(Chairs plugin) {
        plugin.getServer().getPluginManager().registerEvents(this, plugin);
    }
    @EventHandler(priority = EventPriority.NORMAL)
    public void onStairsNorthInnerRight(PlayerInteractEvent event) {
