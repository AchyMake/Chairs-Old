...
public class ChairsClickStairsWestInnerLeft implements Listener {
    public ChairsClickStairsWestInnerLeft(Chairs plugin) {
        plugin.getServer().getPluginManager().registerEvents(this, plugin);
    }
    @EventHandler(priority = EventPriority.NORMAL)
    public void onClickStairsWestInnerLeft(PlayerInteractEvent event) {
        ...
        ChairsSettings.sitStairsWestInnerLeft(event.getPlayer(), event.getClickedBlock().getLocation().add(0.5, -0.4, 0.5));
    }
}