...
public class ChairsClickStairsNorth implements Listener {
    public ChairsClickStairsNorth(Chairs plugin) {
    ...
    public void onClickEvent(PlayerInteractEvent event) {
        ...
        ChairsSettings.sitStairsNorth(event.getPlayer(), event.getClickedBlock().getLocation().add(0.5, -0.4, 0.5));
    }
}