...
public class ChairsClickStairsNorthInnerRight implements Listener {
    ...
    public void onClickStairsNorthInnerRight(PlayerInteractEvent event) {
        ...
        ChairsSettings.sitStairsNorthInnerRight(event.getPlayer(), event.getClickedBlock().getLocation().add(0.5, -0.4, 0.5));
    }
}